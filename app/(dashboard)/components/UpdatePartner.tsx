...
function UpdatePartner() {
    ...
    return (
        <MakeCenter>
          <h1 className='text-xl text-midnight-blue-800 font-bold'>Add a new Partner</h1>
        ...
        <div className='w-full m-4 p-2'>
            <Input type='text' placeholder='Patner Name' value={bName} onChange={(e)=>setBName(e.target.value)} className='border-midnight-blue-800 border-2 rounded-md'/>
        </div>  
        ...
        <div className="flex justify-end gap-3">
              ...
              <Button
                ...
                disabled={isSubmitting}
              >
                {isSubmitting ? 'Processing...' : 'Update Partner'}
              </Button>
            </div>
            </MakeCenter>
      )
